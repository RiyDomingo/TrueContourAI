    ...
    SCReconstructionManagerDelegate
{
    ...
    /// If true, scanning won't auto-stop on early failures; user must stop it manually.
    @objc public var requiresManualFinish: Bool = false
    ...
    @objc public func finishScanNow() {
    ...
    private var _consecutiveFailedCount = 0
